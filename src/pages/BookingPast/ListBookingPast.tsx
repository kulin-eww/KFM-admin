...
const ListBookingPast: React.FC<{
  isLoading: boolean;
  isSuccess: boolean;
  isError: boolean;
  data: any;
  ...
  const getColumns = () => [
    ...
    {
      key: "id",
      label: t("bookingPast.table.bookingId"),
      sortable: true,
      render: (row: any) => {
        return (
          <>
            <div className="flex items-center gap-2">
              <p className="text-secondary">
                {t("bookingPast.table.idPrefix")} <span className="text-primary">#{row.id}</span>
              </p>
            </div>
          </>
        );
    ...
    {
      key: "customer_name",
      label: t("bookingPast.table.customerName"),
      sortable: true,
    ...
    {
      key: "delivered_date",
      label: t("bookingPast.table.deliveryDate"),
      sortable: true,
      accessor: (row: any) => row?.delivered_date?.split("T")[0],
    },
    {
      key: "delivery_address",
      label: t("bookingPast.table.deliveryAddress"),
      sortable: true,
      accessor: (row: any) => row?.address?.full_address,
    },
    {
      key: "pickup_date",
      label: t("bookingPast.table.pickupDate"),
      sortable: true,
      accessor: (row: any) => row?.booking_end_date_time?.split("T")[0],
    },
    {
      key: "booking_date",
      label: t("bookingPast.table.bookingDate"),
      sortable: true,
      accessor: (row: any) => row?.created_at?.split("T")[0],
    },
    {
      key: "isDriverAssigned",
      label: t("bookingPast.table.driverAssigned"),
      sortable: false,
      render: (row: any) => {
        return (
          <span className={row.isDriverAssigned ? "text-[#2BB673] font-medium" : "text-[#D32F2F] font-medium"}>
            {row.isDriverAssigned ? t("bookingPast.table.yes") : t("bookingPast.table.no")}
          </span>
        );
      },
    },
    {
      key: "total_amount",
      label: t("bookingPast.table.amountPaid"),
      sortable: true,
    },
    {
      key: "booking_status",
      label: t("bookingPast.table.bookingStatus"),
      sortable: true,
      render: (row: any) => {
        return (
    ...
    {
      key: "payment_status",
      label: t("bookingPast.table.paymentStatus"),
      sortable: true,
      render: (row: any) => (
        <>
    ...
    {
      key: "actions",
      label: t("bookingPast.table.actions"),
      sortable: false,
          ...
          <div className="relative">
            ...
            <TableMenu
              ...
              menuItems={[
                {
                  icon: EyeIcon,
                  label: t("bookingPast.table.viewAction"),
                  onClick: () => {
...
export default ListBookingPast;
