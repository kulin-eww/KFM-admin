  ...
  return (
    <>
      <div className="flex flex-col p-2 gap-2 h-90 overflow-y-auto">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 last:border-0 py-2">
          <span className="text-gray-700">{t("bookingPast.filter.monthly")}</span>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between border-b border-gray-200 last:border-0 py-2">
          <span className="text-gray-700">{t("bookingPast.filter.yearly")}</span>
          <input
            type="checkbox"
        ...
        <div className="mt-2">
          <label className="text-gray-700 block mb-1">{t("bookingPast.filter.fromDate")}</label>
          <input
            type="date"
        ...
        <div className="mt-2">
          <label className="text-gray-700 block mb-1">{t("bookingPast.filter.toDate")}</label>
          <input
            type="date"
            className="w-full border rounded-lg p-2 text-secondary text-sm focus:ring focus:ring-green-300"
        ...
        >
          {t("bookingPast.filter.applyButton")}
        </Button>
        ...
        >
          {t("bookingPast.filter.resetButton")}
        </Button>
      </div>
    </>
  );
