...
const HeaderBookingCancelled: React.FC<{
  selectedFilters: any;
  ...
  return (
    <>
      <div className="flex sm:flex-row flex-col justify-between items-center px-2 mb-2">
        <div className="text-xl font-bold mb-2">{t("bookingCancelled.header.title")}</div>
        <div className="flex gap-2 flex-shrink-0">
          ...
          >
            {t("bookingCancelled.header.exportCsvButton")}
          </Button>
          <Button
            id="filter-menu"
            variant="contained"
            ...
            sx={{ whiteSpace: "nowrap" }}
          >
            {t("bookingCancelled.header.filterButton")}
          </Button>
        </div>
      </div>
      <FilterMenu
...
export default HeaderBookingCancelled;
