  ...
  return (
    <>
      <div className="flex flex-col p-2 gap-2 h-90 overflow-y-auto">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 last:border-0 py-2">
          <span className="text-gray-700">{t("bookingCancelled.filter.monthly")}</span>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between border-b border-gray-200 last:border-0 py-2">
          <span className="text-gray-700">{t("bookingCancelled.filter.yearly")}</span>
          <input
            type="checkbox"
        ...
        <div className="mt-2">
          <label className="text-gray-700 block mb-1">{t("bookingCancelled.filter.fromDate")}</label>
          <input
            type="date"
            className="w-full border rounded-lg p-2 text-secondary text-sm focus:ring focus:ring-green-300"
            value={localFilters.fromDate}
            onChange={(e) => setLocalFilters({ ...localFilters, monthly: false, yearly: false, fromDate: e.target.value })}
          />
        </div>
        <div className="mt-2">
          <label className="text-gray-700 block mb-1">{t("bookingCancelled.filter.toDate")}</label>
          <input
            type="date"
            className="w-full border rounded-lg p-2 text-secondary text-sm focus:ring focus:ring-green-300"
            value={localFilters.toDate}
            onChange={(e) => setLocalFilters({ ...localFilters, monthly: false, yearly: false, toDate: e.target.value })}
          />
        </div>
        ...
        >
          {t("bookingCancelled.filter.applyButton")}
        </Button>
        ...
        >
          {t("bookingCancelled.filter.resetButton")}
        </Button>
      </div>
    </>
  );
