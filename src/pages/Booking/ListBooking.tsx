  ...
  const getColumns = () => [
    ...
    },
    {
      ...
      render: (row: any) => (
        <>
          <div>
            {i18n.language === "ar" ? row?.waste_type?.name?.ar : row?.waste_type?.name?.en}
          </div>
        </>
      ),
    },
    ...
    { key: "total_quantity", label: t("booking.table.containerQuantity") },
    {
      key: "booking_status",
      label: t("booking.table.currentStatus"),
      sortable: true,
      render: (row: any) => (
        <>
