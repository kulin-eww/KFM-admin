...
const AboutUs = () => {
  ...
  useEffect(() => {
    if (isSuccess) {
      const cmsPageData = data?.data?.find((item: any) => item?.name === "about_us");
      ...
      <main className="flex-1">
        <section className="lg:py-16 py-10">
          <div className="max-w-[84rem] mx-auto px-4">
            <h1 className="text-primary text-2xl/tight font-extrabold md:mb-6 mb-4">{t("cms.aboutUs")}</h1>
