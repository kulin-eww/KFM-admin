...
import FilterMenu from "../../components/Table/FilterMenu";
import FilterReplacementRequest from "./FilterReplacementRequest";

const HeaderReplacementRequest: React.FC<{
  selectedFilters: any;
  ...
  return (
    <>
      <div className="flex sm:flex-row flex-col justify-between items-center px-2 mb-2">
        <div className="text-xl font-bold mb-2">{t("replacementRequest.header.title")}</div>
        <div className="flex gap-2 flex-shrink-0">
          ...
          <Button
            ...
            sx={{ whiteSpace: "nowrap" }}
          >
            {t("replacementRequest.header.filterButton")}
          </Button>
        </div>
      </div>
      <FilterMenu
...
export default HeaderReplacementRequest;
