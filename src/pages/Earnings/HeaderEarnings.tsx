...
import FilterEarnings from "./FilterEarnings";

const HeaderEarnings: React.FC<{ selectedFilters: any; setSelectedFilters: any }> = ({
  selectedFilters,
  setSelectedFilters,
}) => {
  ...
  return (
    <>
      <div className="flex sm:flex-row flex-col justify-between items-center px-2 mb-2">
        <div className="text-xl font-bold mb-2">{t("earnings.header.title")}</div>
        <div className="flex gap-2">
          ...
          >
            {t("earnings.header.filterButton")}
          </Button>
        </div>
      </div>
      <FilterMenu
