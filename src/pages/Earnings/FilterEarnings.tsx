...
const FilterEarnings: React.FC<{ selectedFilters: any; setSelectedFilters: any; setAnchorElId: any }> = ({
  selectedFilters,
  setSelectedFilters,
  setAnchorElId,
}) => {
      ...
      <div className="flex flex-col p-2 gap-2 h-90 overflow-y-auto">
        ...
        <div className="mt-2">
          ...
          <input
            ...
            onChange={(e) =>
              setLocalFilters({ ...localFilters, weekly: false, monthly: false, yearly: false, toDate: e.target.value })
            }
          />
        </div>
